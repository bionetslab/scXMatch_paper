...
import sys
import time
from memento import binary_test_1d
import memento
    ...
    for f in files:
        ...
        for i in datasets:
            ...
            for test_group in groups:
                if test_group == reference:
                    continue    
                current_dataset.obs[["split_50", "split_10", "split_30"]] = processed_adata.obs.loc[current_dataset.obs_names, ["split_50", "split_10", "split_30"]]
